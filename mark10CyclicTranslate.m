function [timeDataO,dispDataO,forceDataO,timeDataO2] = mark10CyclicTranslate(f_serial,f_llimit,f_ulimit,f_cycles,f_sFreq1,f_speed,f_isr,f_handles,f_hObject,f_dOS,f_dIS)
