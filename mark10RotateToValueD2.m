function [timeDataO,rotDataO,torqueDataO,timeDataO2] = mark10RotateToValueD2(f_serial,f_rot,f_sFreq1,f_speed,f_units,axes_yy,plot_yyL,plot_yyR,plotR,f_timeData,f_rotData,f_torqueData,f_auto,f_handles,f_hObject,f_dOS,f_dIS,f_timeData2)
timeDataO=[];
timeDataO2=[];
rotDataO=[];
torqueDataO=[];
